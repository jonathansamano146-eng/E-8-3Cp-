...
titulo = tk.Label(
    ventanabienv,
    text="BIENVENIDOS A MI SOFTWARE DE DETECCIÓN DE ADICCIONES A LAS COMPRAS EN LINEA",
...
texto = tk.Label(
    ventanabienv,
    text="Nos da gusto tenerte aqui.Este espacio esta echo para ayudar a dejar de comprar cosas en linea.",
